...
public class RenderRocketShell extends Render
{
	public void renderDynamite(EntityRocketShell entityarrow, double d, double d1, double d2, float f, float f1)
	{
	...
	{
		renderDynamite((EntityRocketShell) entity, d, d1, d2, f, f1);
	}
	
	@Override
	protected ResourceLocation getEntityTexture(Entity entity)
	{
		return WeaponModResources.Textures.ROCKETSHELL;
	}
}

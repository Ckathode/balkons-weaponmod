...
public class RenderCrossbowBolt extends Render
{
	public void renderCrossbowBolt(EntityCrossbowBolt entityarrow, double d, double d1, double d2, float f, float f1)
	{
		...
		tessellator.addVertexWithUV(-4D, -2D, -2D, f6, f8);//纹理(0,5/32)
		tessellator.addVertexWithUV(-4D, -2D, 2D, f7, f8);//纹理(5/32,5/32)
		tessellator.addVertexWithUV(-4D, 2D, 2D, f7, f9);//纹理(5/32,10/32)
		tessellator.addVertexWithUV(-4D, 2D, -2D, f6, f9);//纹理(0,10/32)
		tessellator.draw();
		...
		for (int j = 0; j < 4; j++)
		{
			...
			tessellator.addVertexWithUV(5D, -2D, 0.0D, f3, f4);//纹理(16/32,0)
			tessellator.addVertexWithUV(5D, 2D, 0.0D, f3, f5);//纹理(16/32,5/32)

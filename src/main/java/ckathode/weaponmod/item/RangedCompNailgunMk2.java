...
public class RangedCompNailgunMk2 extends RangedComponent
{

	public RangedCompNailgunMk2()
	{
		super(RangedSpecs.NAILGUNMK2, null);
	}
	...
	public void fire(ItemStack itemstack, World world, EntityPlayer entityplayer, int i)
	{
		...
		if (!world.isRemote)
		{
			EntityScrew entityscrew = new EntityScrew(world, entityplayer, 5.0F, 3F);

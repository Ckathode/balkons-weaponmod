...
public abstract class WeaponModResources
{
	public static abstract class Textures
	{
		...
		public static final ResourceLocation	ROCKETSHELL			= new ResourceLocation("weaponmod", "textures/entity/rocket_shell.png");
		public static final ResourceLocation	SCREW				= new ResourceLocation("weaponmod", "textures/entity/screw.png");
